  ...
  return (
    <main className="bg-ns-cream min-h-screen p-4">
      <div className="max-w-2xl mx-auto mb-4">
        ...
        <p className="text-sm text-gray-500">Signed in as {session?.user?.name} · <a href="/teacher/assessments" className="text-ns-blue underline">My Assessments</a> · <a href="/account" className="text-ns-blue underline">My Account</a></p>
      </div>
